...
public class CR_FileInitTests {
	...
	public void testBadColumns() throws BadConfigFormatException, FileNotFoundException, IOException {
	...
	// Test that an exception is thrown for a bad config file
	@Test (expected = BadConfigFormatException.class)
	public void testBadRoom() throws BadConfigFormatException, FileNotFoundException, IOException {
	...
	@Test (expected = BadConfigFormatException.class)
	public void testBadRoomFormat() throws BadConfigFormatException, FileNotFoundException, IOException {
